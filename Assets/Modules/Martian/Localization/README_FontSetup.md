...
- 字体文件目录：`Assets/Modules/Martian/Localization/Resources/Fonts/SourceHanSansSC/`
...
- Localization Settings：`Assets/Modules/Martian/Localization/Project/Settings/Localization Settings.asset`
- Locales：`Assets/Modules/Martian/Localization/Project/Locales/`
- String Tables：`Assets/Modules/Martian/Localization/Project/Tables/`
- 字体配置真源：`Assets/Modules/Martian/Localization/Resources/Localization/LocalizationFontProfile.asset`
