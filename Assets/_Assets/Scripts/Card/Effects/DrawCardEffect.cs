...
namespace BaoZuPo.Card.Effects
{
    ...
    public class DrawCardEffect : ICardEffect
    {
        ...
        {
            CardLibrary library = ResolveLibrary();
            if (library == null)
            {
            ...
            Deck.DeckManager.Instance.DrawFromLibrary(library, _count);
        ...
        private CardLibrary ResolveLibrary()
        {
            ...
            return GameManager.Instance != null && GameManager.Instance.gameConfig != null
