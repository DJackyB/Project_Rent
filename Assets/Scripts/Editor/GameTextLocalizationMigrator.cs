...
namespace BaoZuPo.Editor.Localization
{
    ...
    {
        private const string GameTextPath = "Assets/Scripts/Runtime/UI/GameText.cs";
        private const string TsvOutputPath = "Assets/Data/Localization/GameText.csv";
        private const string CardCsvPath = "Assets/Data/Localization/Card.csv";
        private const string LocalizationAssetDir = "Assets/Data/Localization";
